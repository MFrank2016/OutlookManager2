...
function searchApiDocs() {
    ...
    apiSections.forEach(section => {
        const title = section.querySelector('.api-section-title')?.textContent.toLowerCase() || '';
        const content = section.querySelector('.api-section-content')?.textContent.toLowerCase() || '';
...
function generateApiDocsToc() {
    ...
    sections.forEach((section, index) => {
        const title = section.querySelector('.api-section-title')?.textContent || `Section ${index + 1}`;
